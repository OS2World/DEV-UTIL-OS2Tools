/* $Id: ccollection.cpp,v 1.1 2002/01/10 16:24:47 phaller Exp $ */

/*
 * Collection class:
 *   provides very fast object lookup by index number
 *
 * Copyright 2000 InnoTek Systemberatung GmbH
 *
 *
 */
...
void CLinearList::removeElement(PLINEARLISTENTRY pLLE)
{
    ...
    // free object pointer if necessary
    if (NULL != pLLE->pObject)
      free( pLLE->pObject );
