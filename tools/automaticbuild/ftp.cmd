/* $Id: ftp.cmd,v 1.1 2002/01/11 22:13:03 bird Exp $
 *
 ...
 */
if (/*DATE('B')//7 = 3*/ 1) then              /* Thursdays only! */
do  /* weekly .wpi build */
    asUploads.0 = 3;
    asUploads.1 = 'ChangeLog';
    asUploads.2 = 'os2toolsbin-'DATE('S')'-release.zip';
    asUploads.3 = 'os2toolsbin-'DATE('S')'-debug.zip';
    sDirectory  = 'weekly';
end
else
do  /* daily .zip build */
